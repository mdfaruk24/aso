...
class Landing extends Component {
    ...
    render() {
        return (
            <div className="landing-page-aura">
                                ...
                                <div className="top-header">
                                    ...
                                    <div>
                                        <form target="_blank" className="form-inline my-lg-0"
                                            action="https://themeforest.net/item/aura-responsive-react-ecommerce-template/23067773">
                ...
                <section className="main-img responsive-img  pt-0" id="img-bg">
                    <div className="container-fluid">
                        <div className="main-contain">
                            <div>
                                <h1 className="m-0">AURA<span>SHOP ONLINE</span></h1>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="feature text-center">
                                    <div>
                                        <h5 className="title-landing">Reasones to Buy Aura</h5>
                                        <p className="pb-3">Aura HTML template is an apparently simple but highly
                        ...
                        <div className="row feature_row">
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Aura is a clean and morfern responsive template.it will perfectly suit for any type of online store</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Aura has powerful backend admin panel to manage products, sales, discount coupons, orders, user, vendor and much more.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Aura comes with 4 email template which include two order success template & two email template</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Aura provides multiple portfolio pages which includes 3 grid view & 4 masonary view.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                            ...
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Every store has different image size weather its tools or fashion we have covered all image size for all your store needs , it has auto resize image option in aura</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                            ...
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Design your website LTR or RTL , Aura supports multi-languages so its easy to design website on any layout such as arabic , urdu..</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="admin" className="section-b-space pt-0">
                    <div className="container">
                        ...
                        <div className="row">
                    <div className="col-xl-3 col-sm-6 col-12 demo-box">
                        <a href="https://react.pixelstrap.com/aura-admin/dashboard" target="_blank">
                            <img src={`${process.env.PUBLIC_URL}/assets/images/landing-page/admin/1.jpg`} className="img-fluid lazyload" />
                        </a>
                        <h3>dashboard</h3>
                    </div>
                    <div className="col-xl-3 col-sm-6 col-12 demo-box">
                        <a href="https://react.pixelstrap.com/aura-admin/products/physical/product-list" target="_blank">
                            <img src={`${process.env.PUBLIC_URL}/assets/images/landing-page/admin/2.jpg`} className="img-fluid lazyload" />
                        </a>
                        <h3>product list</h3>
                    </div>
                    <div className="col-xl-3 col-sm-6 col-12 demo-box">
                        <a href="https://react.pixelstrap.com/aura-admin/reports/report" target="_blank">
                            <img src={`${process.env.PUBLIC_URL}/assets/images/landing-page/admin/3.jpg`} className="img-fluid lazyload" />
                        </a>
                        <h3>report page</h3>
                    </div>
                    <div className="col-xl-3 col-sm-6 col-12 demo-box">
                        <a href="https://react.pixelstrap.com/aura-admin/media" target="_blank">
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-4 offset-md-1 text-center center-part">
                                ...
                                <p className="pb-3">Aura come with 4+ email template which include two order
                            ...
                            <div className="col">
                                <div className="footer-section">
                                    <div>
                                        ...
                                        <h2>purchase the aura <br />
                                            & create beautiful online store</h2>
                                        <a target="_blank"
                                            href="https://themeforest.net/item/aura-responsive-react-ecommerce-template/23067773?s_rank=3"
